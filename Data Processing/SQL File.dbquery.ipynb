{
 "cells": [
  {
   ...
   "metadata": {
    "application/vnd.databricks.v1+cell": {
     "cellMetadata": {},
     "inputWidgets": {},
     "nuid": "60f0ee4d-04fd-459b-937c-2c4860921819",
     "showTitle": false,
   ...
   "source": [
    ...
    "        Channel2 AS Channel, \n",
    "        date_format(TO_TIMESTAMP(RecordDate22, 'yyyy:MM:DD'), 'yyyy:MM:dd') AS RecordDate, ---Record date\n",
    "        Monthname(RecordDate22) AS Month_name, -- Get the month name (e.g., Jan, Mar.etc)\n",
 ...
 "metadata": {
  "application/vnd.databricks.v1+notebook": {
   ...
   "notebookName": "SQL File.dbquery.ipynb",
   "widgets": {}
  },
  "language_info": {
   "name": "sql"
